...
| --- | --- | --- | --- |
| `rankboard-1.10.1+mc1.21.x.jar` | 1.21–1.21.11 | Java 21+ | 0.15.11+ |
| `rankboard-1.10.1+mc26.1.x.jar` | 26.1.x | Java 25+ | 0.18.6+ |
| `rankboard-1.10.1+mc26.2.x.jar` | 26.2.x | Java 25+ | 0.18.6+ |
