...
“分类浏览榜单”用于按分类找到榜单，再选择时间并进入操作页，可选择 Top 数量、设为个人侧边栏；OP 还可设为全服侧边栏，或选择在线玩家后显示/关闭其个人侧边栏。
...
/leaderboard menu personal <周期>                   点击设置或关闭自己的侧边栏
/leaderboard menu quick                              个人侧边栏、轮播、抬头蹲起与统计快捷操作
...
```text
/leaderboard menu server <周期>                     点击设置或清除全服共享侧边栏
